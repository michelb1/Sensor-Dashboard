...
@Configuration
@EnableJpaRepositories(basePackages = "com.github.michelb1.sensordataserver.repository")
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setPassword(env.getProperty("dbpw"));
        return dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.github.michelb1.sensordataserver.entities"});
